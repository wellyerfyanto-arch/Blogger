...
# Initialize the AutoPostingSystem - HARUS DI SINI SETELAH CLASS DEFINITION
try:
...
# Routes - SEMUA ROUTES HARUS SETELAH INISIALISASI auto_poster
@app.route('/')
def index():
    """Main dashboard"""
    try:
        ...
        if 'auto_poster' not in globals():
            ...
            return render_template('error.html', error="System not properly initialized"), 500
...
# [Semua route API yang menggunakan auto_poster]
